    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td style="padding:20px;text-align:left;">
                <h2 style="margin:0 0 8px 0;">ST Inventory Portal</h2>
                <p style="margin:0 0 16px 0;color:#666;">Automated security notification from ST Inventory Portal</p>
                <hr style="border:none;border-top:1px solid #eee;margin:12px 0;">
                <p style="font-size:15px;line-height:1.5;margin:0 0 12px 0;">Hello,</p>
                <p style="font-size:15px;line-height:1.5;margin:0 0 12px 0;">A registration attempt was made using this email address on the ST Inventory Portal.</p>
