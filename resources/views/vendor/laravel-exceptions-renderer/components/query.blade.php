...
>
    ...
    <div class="flex flex-col gap-1">
        @php($visibleQueries = array_slice($queries, 0, 100))
        @if (count($visibleQueries) > 0)
        @foreach ($visibleQueries as $index => $query)
        <div
        ...
        >
            <div class="flex items-center gap-2 truncate">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-neutral-500 dark:text-neutral-400">{{ $query['connectionName'] }}</span>
                </div>
                <x-laravel-exceptions-renderer::syntax-highlight
                    ...
                    truncate
                    class="min-w-0"
                    data-tippy-content="{{ nl2br($query['sql']) }}"
                />
            </div>
            <div class="text-neutral-500 dark:text-neutral-200 text-right flex-shrink-0">{{ $query['time'] }}ms</div>
        </div>
        @endforeach
        @else
